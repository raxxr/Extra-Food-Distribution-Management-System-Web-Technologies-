...
<body>
    ...
    <table border="1" align="center">
            <tr>
                ...
                <th width="40%"><font color="blue"><center>Vote</center></font></th>
            </tr>
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <center>
                            <form  method="post" action=<?="'votecontroller.php?id=".$row['id']."'"?>>
                            <center><input type = 'submit' class="button" name='vote' value='vote' ></center>
                            </form>
                            <form  method="post" action=<?="'eventdetails.php?id=".$row['id']."'"?>>
                            <center><input type = 'submit' class="button" name='detailss' value='details' ></center>
                            </form>
                        </center>
                    </td>
                </tr>
